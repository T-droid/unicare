...
import { Users, UserPlus, Activity, Settings, Menu, X, UserCheck } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const menuItems = [
    { icon: UserPlus, label: 'Register Staff', route: '/admin/register-staff', color: 'text-blue-600' },
    { icon: Users, label: 'Manage Staff', route: '/admin/manage-staff', color: 'text-green-600' },
    { icon: UserCheck, label: 'Register Student', route: '/admin/register-student', color: 'text-indigo-600' },
  ...
  return (
    <>
      {/* Mobile menu button - moved to fixed top-right */}
      <button
      ...
      <div
        ...
        `}
      >
        {/* Header with sufficient padding */}
