...
const AdminDashboard = () => {
  ...
  const recentActivities = [
    { id: 1, action: 'Patient record created - John Smith', time: '2 minutes ago', type: 'medical' },
    { id: 2, action: 'Medical prescription updated - Sarah Johnson', time: '15 minutes ago', type: 'medical' },
    { id: 3, action: 'Medical test results added - Mike Brown', time: '1 hour ago', type: 'medical' },
    { id: 4, action: 'Emergency treatment recorded - Jane Doe', time: '2 hours ago', type: 'medical' },
];
